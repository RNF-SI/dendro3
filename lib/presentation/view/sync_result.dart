      ...
      return SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Divider(),
            Text("Distant CorCyclesPlacettes:"),
            Text("  Created: ${results.distantCorCyclesPlacettes.created}"),
            Text("  Updated: ${results.distantCorCyclesPlacettes.updated}"),
            Text("  Deleted: ${results.distantCorCyclesPlacettes.deleted}"),
            Divider(),
            Text("Distant Regenerations:"),
            Text("  Created: ${results.distantRegenerations.created}"),
            Text("  Updated: ${results.distantRegenerations.updated}"),
            Text("  Deleted: ${results.distantRegenerations.deleted}"),
            Divider(),
            Text("Distant Transects:"),
            Text("  Created: ${results.distantTransects.created}"),
            Text("  Updated: ${results.distantTransects.updated}"),
            Text("  Deleted: ${results.distantTransects.deleted}"),
          ],
        ),
      );
    }
