...
/// @nodoc
abstract class $NomenclatureTypeCopyWith<$Res> {
  factory $NomenclatureTypeCopyWith(
          NomenclatureType value, $Res Function(NomenclatureType) then) =
      _$NomenclatureTypeCopyWithImpl<$Res, NomenclatureType>;
  @useResult
  $Res call(
      {int idType,
      String? mnemonique,
...
/// @nodoc
class _$NomenclatureTypeCopyWithImpl<$Res, $Val extends NomenclatureType>
    implements $NomenclatureTypeCopyWith<$Res> {
  _$NomenclatureTypeCopyWithImpl(this._value, this._then);
...
class _$NomenclatureTypeImpl extends _NomenclatureType {
  ...
  @override
  String toString() {
    return 'NomenclatureType(idType: $idType, mnemonique: $mnemonique, labelDefault: $labelDefault, definitionDefault: $definitionDefault, labelFr: $labelFr, definitionFr: $definitionFr, labelEn: $labelEn, definitionEn: $definitionEn, labelEs: $labelEs, definitionEs: $definitionEs, labelDe: $labelDe, definitionDe: $definitionDe, labelIt: $labelIt, definitionIt: $definitionIt, source: $source, statut: $statut)';
  }
...
abstract class _NomenclatureType extends NomenclatureType {
  const factory _NomenclatureType(
